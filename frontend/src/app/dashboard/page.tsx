  ...
  return (
    <div className="flex-1 space-y-8 bg-slate-50 text-slate-900 pb-12 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 sm:gap-6">
        {/* Metric 1 */}
        <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200/90 space-y-3 shadow-2xs">
          <div className="flex items-center justify-between text-xs text-slate-500 font-medium">
            <span>Total Audits</span>
            <span className="text-emerald-700 font-semibold">+12% this month</span>
          </div>
          <div className="text-3xl sm:text-4xl font-serif font-black text-slate-900">{MOCK_METRICS.totalAudits}</div>
        ...
        <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200/90 space-y-3 shadow-2xs">
          ...
          <div className="text-3xl sm:text-4xl font-serif font-black text-emerald-700">{MOCK_METRICS.compliancePassRate}%</div>
        ...
        <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200/90 space-y-3 shadow-2xs">
          ...
          <div className="text-3xl sm:text-4xl font-serif font-black text-slate-900">{MOCK_METRICS.totalRedlines}</div>
        ...
        <div className="p-6 sm:p-7 rounded-2xl bg-white border border-slate-200/90 space-y-3 shadow-2xs">
          ...
          <div className="text-3xl sm:text-4xl font-serif font-black text-red-700">{MOCK_METRICS.criticalFlags}</div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 xl:gap-8 items-start">
        ...
        <div className="xl:col-span-8 p-6 sm:p-7 rounded-2xl bg-white border border-slate-200/90 space-y-5 shadow-2xs">
            ...
            <table className="w-full text-left text-xs min-w-[600px]">
              <thead className="text-[11px] font-semibold text-slate-500 uppercase bg-slate-50/80 border-b border-slate-200">
                <tr>
                  ...
                  <th className="py-3.5 px-4">Playbook</th>
                  ...
                  <tr key={doc.id} className="hover:bg-slate-50/80 transition-all">
                    <td className="py-4 px-4 font-semibold text-slate-900">
                      <div className="flex items-center space-x-3">
                        <span className="p-1.5 rounded bg-slate-100 text-slate-700 text-[10px] uppercase font-mono border border-slate-200 shrink-0">
                          {doc.fileType}
                        </span>
                        <span className="truncate max-w-[240px] font-serif text-sm">{doc.contractName}</span>
                      </div>
                    </td>
                    <td className="py-4 px-4 text-slate-600 truncate max-w-[160px] font-medium">{doc.playbookName}</td>
                    ...
                    <td className="py-4 px-4 text-right">
                      <Link
                        ...
                        className="px-3.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-[11px] transition-all inline-block shadow-2xs"
                      >
                        Review Workspace
                      </Link>
                    </td>
        ...
        <div className="xl:col-span-4 p-6 sm:p-7 rounded-2xl bg-white border border-slate-200/90 space-y-5 shadow-2xs">
