...
export default function TopHeader() {
  ...
  return (
    <header className="h-20 bg-white/90 backdrop-blur-md border-b border-slate-200/90 text-slate-800 px-6 lg:px-10 flex items-center justify-between sticky top-0 z-30 transition-all">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="hidden md:flex items-center space-x-2 text-xs font-semibold text-slate-500 font-mono">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-slate-100/90 border border-slate-200 text-xs font-mono">
        ...
        <Link
          href="/upload"
          className="px-5 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs shadow-sm transition-all hover-lift btn-tactile flex items-center space-x-2"
        >
